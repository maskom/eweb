  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-list-article">
        <a href="<?php echo $news_url;?>" title="<?php echo $source_title; ?>" target="_blank"><img src="<?php echo $picture;?>" class="card-image-top img-fluid" alt="<?php echo $source_title; ?>"/></a>
        <div class="card-block">
          <article <?php post_class(); ?>>
            <h5 class="entry-title card-title"><a href="<?php echo $news_url;?>" target="_blank"><?php echo $source_title; ?></a></h5>
      ...
      if( $my_query->have_posts() ) {
        while ($my_query->have_posts()) : $my_query->the_post(); ?>
          ...
          <div class="card card-small ">
            ...
            <div class="card-block">
              <h6 class="card-title">
                <a href="<?php the_permalink()?>" title="<?php echo $source_title; ?>"><?php echo $source_title; ?></a>
              </h6>
            </div>
            <div class="card-footer">
              <div class="wrap_tags">
